...
double LF(vector<double> masses, int code, double mubarsq) {
    switch(code) {
        ...
        case 18: 
            ...
            break;
        case 19: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},4,mubarsq); }
            ...
            break;
        case 20: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},5,mubarsq); }
            ...
            break;
        case 21: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},8,mubarsq); }
            ...
            break;
        case 22: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},10,mubarsq); }
            ...
            break;
        case 23: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},11,mubarsq); }
            ...
            break;
        case 24: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},13,mubarsq); }
            ...
            break;
        case 25: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},14,mubarsq); }
            ...
            break;
        case 26: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},18,mubarsq); }
            ...
            break;
        case 27: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},7,mubarsq); }
        ...
        case 28: 
            ...
            break;
        case 29: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},9,mubarsq); }
        ...
        case 31: 
            ...
            break;
        case 32: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},12,mubarsq); }
        ...
        case 34: 
            ...
            break;
        case 35: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},17,mubarsq); }
        ...
        case 42: 
            ...
            break;
        case 43: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},15,mubarsq); }
            ...
            break;
        case 44: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0]},16,mubarsq); }
        ...
        case 57: 
            ...
            break;
        case 58: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},28,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},28,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},21,mubarsq); }
            ...
            break;
        case 59: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},30,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},38,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},22,mubarsq); }
            ...
            break;
        case 60: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},31,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},39,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},23,mubarsq); }
            ...
            break;
        case 61: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},33,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},48,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},24,mubarsq); }
            ...
            break;
        case 62: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},34,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},49,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},25,mubarsq); }
            ...
            break;
        case 63: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},36,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},57,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},26,mubarsq); }
            ...
            break;
        case 64: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},38,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},30,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},22,mubarsq); }
            ...
            break;
        case 65: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},39,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},31,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},23,mubarsq); }
            ...
            break;
        case 66: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},41,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},41,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},24,mubarsq); }
            ...
            break;
        case 67: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},42,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},42,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},25,mubarsq); }
            ...
            break;
        case 68: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},46,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},53,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},26,mubarsq); }
            ...
            break;
        case 69: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},48,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},33,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},24,mubarsq); }
            ...
            break;
        case 70: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},49,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},34,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},25,mubarsq); }
            ...
            break;
        case 71: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},53,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},46,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},26,mubarsq); }
            ...
            break;
        case 72: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},57,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},36,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},26,mubarsq); }
            ...
            break;
        case 73: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},37,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},37,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},29,mubarsq); }
        ...
        case 74: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},30,mubarsq); }
        ...
        case 75: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},31,mubarsq); }
            ...
            break;
        case 76: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},40,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},47,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},32,mubarsq); }
        ...
        case 77: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},33,mubarsq); }
        ...
        case 78: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},34,mubarsq); }
        ...
        case 79: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},36,mubarsq); }
            ...
            break;
        case 80: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},47,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},40,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},32,mubarsq); }
        ...
        case 82: 
            ...
            break;
        case 83: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},52,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},52,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},35,mubarsq); }
        ...
        case 84: 
            ...
            break;
        case 85: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},56,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},45,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},35,mubarsq); }
        ...
        case 87: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},40,mubarsq); }
        ...
        case 88: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},41,mubarsq); }
        ...
        case 89: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},42,mubarsq); }
        ...
        case 90: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},52,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},56,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},45,mubarsq); }
        ...
        case 91: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},46,mubarsq); }
            ...
            break;
        case 92: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},54,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},50,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},43,mubarsq); }
            ...
            break;
        case 93: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},55,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},51,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},44,mubarsq); }
        ...
        case 96: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},54,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},54,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},50,mubarsq); }
        ...
        case 97: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2]},55,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},55,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},51,mubarsq); }
        ...
        case 98: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},52,mubarsq); }
        ...
        case 99: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1]},53,mubarsq); }
            ...
            break;
        case 100: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},74,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},74,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},74,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},64,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},64,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},59,mubarsq); }
            ...
            break;
        case 101: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},75,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},75,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},75,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},65,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},65,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},60,mubarsq); }
            ...
            break;
        case 102: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},77,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},77,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},88,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},66,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},69,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},61,mubarsq); }
            ...
            break;
        case 103: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},78,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},78,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},89,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},67,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},70,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},62,mubarsq); }
            ...
            break;
        case 104: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},79,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},79,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},99,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},68,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},72,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},63,mubarsq); }
            ...
            break;
        case 105: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},81,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},88,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},77,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},69,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},66,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},61,mubarsq); }
            ...
            break;
        case 106: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},82,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},89,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},78,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},70,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},67,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},62,mubarsq); }
            ...
            break;
        case 107: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},84,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},91,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},91,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},71,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},71,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},63,mubarsq); }
            ...
            break;
        case 108: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},86,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},99,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},79,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},72,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},68,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},63,mubarsq); }
            ...
            break;
        case 109: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},88,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},81,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},81,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},69,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},69,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},66,mubarsq); }
            ...
            break;
        case 110: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},89,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},82,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},82,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},70,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},70,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},67,mubarsq); }
            ...
            break;
        case 111: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},91,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},84,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},95,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},71,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},72,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},68,mubarsq); }
            ...
            break;
        case 112: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},95,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},95,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},84,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},72,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},71,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},68,mubarsq); }
            ...
            break;
        case 113: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},99,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},86,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},86,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},72,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},72,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},71,mubarsq); }
            ...
            break;
        case 114: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},87,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},87,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},87,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},80,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},80,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},76,mubarsq); }
        ...
        case 115: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},81,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},81,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},77,mubarsq); }
        ...
        case 116: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},82,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},82,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},78,mubarsq); }
        ...
        case 117: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},84,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},86,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},79,mubarsq); }
        ...
        case 118: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},86,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},84,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},79,mubarsq); }
            ...
            break;
        case 119: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},98,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},94,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},94,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},85,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},85,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},83,mubarsq); }
        ...
        case 120: 
            ...
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},84,mubarsq); }
        ...
        case 121: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3]},98,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},98,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},98,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},94,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},94,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},90,mubarsq); }
        ...
        case 122: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3]},95,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},95,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2]},91,mubarsq); }
            ...
            break;
        case 123: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3],masses[4]},115,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},115,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},115,mubarsq); }
            else if (masses[0] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},115,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},109,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},109,mubarsq); }
            else if (masses[1] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},109,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},105,mubarsq); }
            else if (masses[2] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},105,mubarsq); }
            else if (masses[3] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},102,mubarsq); }
            ...
            break;
        case 124: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3],masses[4]},116,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},116,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},116,mubarsq); }
            else if (masses[0] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},116,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},110,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},110,mubarsq); }
            else if (masses[1] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},110,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},106,mubarsq); }
            else if (masses[2] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},106,mubarsq); }
            else if (masses[3] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},103,mubarsq); }
            ...
            break;
        case 125: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3],masses[4]},117,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},117,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},117,mubarsq); }
            else if (masses[0] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},122,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},111,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},111,mubarsq); }
            else if (masses[1] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},113,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},107,mubarsq); }
            else if (masses[2] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},108,mubarsq); }
            else if (masses[3] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},104,mubarsq); }
            ...
            break;
        case 126: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3],masses[4]},118,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},118,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},122,mubarsq); }
            else if (masses[0] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},117,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},112,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},113,mubarsq); }
            else if (masses[1] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},111,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},108,mubarsq); }
            else if (masses[2] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},107,mubarsq); }
            else if (masses[3] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},104,mubarsq); }
            ...
            break;
        case 127: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3],masses[4]},120,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},122,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},118,mubarsq); }
            else if (masses[0] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},118,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},113,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},112,mubarsq); }
            else if (masses[1] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},112,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},108,mubarsq); }
            else if (masses[2] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},108,mubarsq); }
            else if (masses[3] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},107,mubarsq); }
            ...
            break;
        case 128: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3],masses[4]},122,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},120,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},120,mubarsq); }
            else if (masses[0] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},120,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},113,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},113,mubarsq); }
            else if (masses[1] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},113,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},112,mubarsq); }
            else if (masses[2] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},112,mubarsq); }
            else if (masses[3] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},111,mubarsq); }
        ...
        case 129: 
            ...
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4]},120,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},120,mubarsq); }
            else if (masses[1] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},120,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4]},118,mubarsq); }
            else if (masses[2] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},118,mubarsq); }
            else if (masses[3] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3]},117,mubarsq); }
            ...
            break;
        case 130: 
            if (masses[0] - masses[1] < 1e-6) { return LF({masses[0],masses[2],masses[3],masses[4],masses[5]},129,mubarsq); }
            else if (masses[0] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4],masses[5]},129,mubarsq); }
            else if (masses[0] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4],masses[5]},129,mubarsq); }
            else if (masses[0] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3],masses[5]},129,mubarsq); }
            else if (masses[0] - masses[5] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},129,mubarsq); }
            else if (masses[1] - masses[2] < 1e-6) { return LF({masses[0],masses[1],masses[3],masses[4],masses[5]},128,mubarsq); }
            else if (masses[1] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4],masses[5]},128,mubarsq); }
            else if (masses[1] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3],masses[5]},128,mubarsq); }
            else if (masses[1] - masses[5] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},128,mubarsq); }
            else if (masses[2] - masses[3] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[4],masses[5]},127,mubarsq); }
            else if (masses[2] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3],masses[5]},127,mubarsq); }
            else if (masses[2] - masses[5] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},127,mubarsq); }
            else if (masses[3] - masses[4] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3],masses[5]},126,mubarsq); }
            else if (masses[3] - masses[5] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},126,mubarsq); }
            else if (masses[4] - masses[5] < 1e-6) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},125,mubarsq); }
