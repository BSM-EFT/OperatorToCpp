...
double LF(vector<double> masses, int code, double mubarsq) {
    switch(code) {
        ...
        case 58: 
            ...
            break;
        case 59: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2]},30,mubarsq); }
        ...
        case 60: 
            ...
            break;
        case 61: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2]},33,mubarsq); }
        ...
        case 62: 
            ...
            break;
        case 63: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2]},36,mubarsq); }
        ...
        case 64: 
            ...
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1]},30,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1]},22,mubarsq); }
        ...
        case 67: 
            ...
            break;
        case 68: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2]},46,mubarsq); }
        ...
        case 69: 
            ...
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1]},33,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1]},24,mubarsq); }
        ...
        case 72: 
            ...
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1]},36,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1]},26,mubarsq); }
        ...
        case 73: 
            ...
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1]},29,mubarsq); }
        ...
        case 82: 
            ...
            break;
        case 83: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2]},52,mubarsq); }
        ...
        case 85: 
            ...
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1]},45,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1]},35,mubarsq); }
        ...
        case 87: 
            ...
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1]},40,mubarsq); }
        ...
        case 96: 
            ...
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1]},50,mubarsq); }
        ...
        case 99: 
            ...
            break;
        case 100: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2],masses[3]},74,mubarsq); }
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3]},74,mubarsq); }
            else if (masses[0] == masses[3]) { return LF({masses[0],masses[1],masses[2]},74,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3]},64,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2]},64,mubarsq); }
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2]},59,mubarsq); }
            ...
            break;
        case 101: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2],masses[3]},75,mubarsq); }
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3]},75,mubarsq); }
            else if (masses[0] == masses[3]) { return LF({masses[0],masses[1],masses[2]},75,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3]},65,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2]},65,mubarsq); }
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2]},60,mubarsq); }
        ...
        case 102: 
            ...
            break;
        case 103: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2],masses[3]},78,mubarsq); }
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3]},78,mubarsq); }
        ...
        case 104: 
            ...
            else if (masses[0] == masses[3]) { return LF({masses[0],masses[1],masses[2]},99,mubarsq); }
        ...
        case 105: 
            ...
            break;
        case 106: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2],masses[3]},82,mubarsq); }
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3]},89,mubarsq); }
            else if (masses[0] == masses[3]) { return LF({masses[0],masses[1],masses[2]},78,mubarsq); }
        ...
        case 108: 
            ...
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3]},99,mubarsq); }
        ...
        case 109: 
            ...
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2]},66,mubarsq); }
        ...
        case 110: 
            ...
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3]},82,mubarsq); }
            else if (masses[0] == masses[3]) { return LF({masses[0],masses[1],masses[2]},82,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3]},70,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2]},70,mubarsq); }
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2]},67,mubarsq); }
        ...
        case 111: 
            ...
            else if (masses[0] == masses[3]) { return LF({masses[0],masses[1],masses[2]},95,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3]},71,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2]},72,mubarsq); }
            ...
            break;
        case 112: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2],masses[3]},95,mubarsq); }
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3]},95,mubarsq); }
            ...
            break;
        case 113: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2],masses[3]},99,mubarsq); }
            ...
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2]},71,mubarsq); }
            ...
            break;
        case 114: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2],masses[3]},87,mubarsq); }
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3]},87,mubarsq); }
            else if (masses[0] == masses[3]) { return LF({masses[0],masses[1],masses[2]},87,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3]},80,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2]},80,mubarsq); }
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2]},76,mubarsq); }
        ...
        case 115: 
            ...
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3]},81,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2]},81,mubarsq); }
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2]},77,mubarsq); }
        ...
        case 118: 
            ...
            break;
        case 119: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2],masses[3]},98,mubarsq); }
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3]},94,mubarsq); }
            else if (masses[0] == masses[3]) { return LF({masses[0],masses[1],masses[2]},94,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3]},85,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2]},85,mubarsq); }
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2]},83,mubarsq); }
        ...
        case 120: 
            ...
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2]},84,mubarsq); }
        ...
        case 121: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2],masses[3]},98,mubarsq); }
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3]},98,mubarsq); }
            else if (masses[0] == masses[3]) { return LF({masses[0],masses[1],masses[2]},98,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3]},94,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2]},94,mubarsq); }
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2]},90,mubarsq); }
        ...
        case 122: 
            ...
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3]},95,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2]},95,mubarsq); }
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2]},91,mubarsq); }
            ...
            break;
        case 123: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2],masses[3],masses[4]},115,mubarsq); }
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3],masses[4]},115,mubarsq); }
            else if (masses[0] == masses[3]) { return LF({masses[0],masses[1],masses[2],masses[4]},115,mubarsq); }
            else if (masses[0] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},115,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3],masses[4]},109,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2],masses[4]},109,mubarsq); }
            else if (masses[1] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},109,mubarsq); }
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2],masses[4]},105,mubarsq); }
            else if (masses[2] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},105,mubarsq); }
            else if (masses[3] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},102,mubarsq); }
            ...
            break;
        case 124: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2],masses[3],masses[4]},116,mubarsq); }
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3],masses[4]},116,mubarsq); }
            else if (masses[0] == masses[3]) { return LF({masses[0],masses[1],masses[2],masses[4]},116,mubarsq); }
            else if (masses[0] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},116,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3],masses[4]},110,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2],masses[4]},110,mubarsq); }
            else if (masses[1] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},110,mubarsq); }
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2],masses[4]},106,mubarsq); }
            else if (masses[2] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},106,mubarsq); }
            else if (masses[3] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},103,mubarsq); }
        ...
        case 127: 
            ...
            else if (masses[3] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},107,mubarsq); }
        ...
        case 128: 
            ...
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2],masses[4]},112,mubarsq); }
            else if (masses[2] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},112,mubarsq); }
            else if (masses[3] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},111,mubarsq); }
        ...
        case 129: 
            ...
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3],masses[4]},120,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2],masses[4]},120,mubarsq); }
            else if (masses[1] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},120,mubarsq); }
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2],masses[4]},118,mubarsq); }
            else if (masses[2] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},118,mubarsq); }
            else if (masses[3] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3]},117,mubarsq); }
            ...
            break;
        case 130: 
            if (masses[0] == masses[1]) { return LF({masses[0],masses[2],masses[3],masses[4],masses[5]},129,mubarsq); }
            else if (masses[0] == masses[2]) { return LF({masses[0],masses[1],masses[3],masses[4],masses[5]},129,mubarsq); }
            else if (masses[0] == masses[3]) { return LF({masses[0],masses[1],masses[2],masses[4],masses[5]},129,mubarsq); }
            else if (masses[0] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3],masses[5]},129,mubarsq); }
            else if (masses[0] == masses[5]) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},129,mubarsq); }
            else if (masses[1] == masses[2]) { return LF({masses[0],masses[1],masses[3],masses[4],masses[5]},128,mubarsq); }
            else if (masses[1] == masses[3]) { return LF({masses[0],masses[1],masses[2],masses[4],masses[5]},128,mubarsq); }
            else if (masses[1] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3],masses[5]},128,mubarsq); }
            else if (masses[1] == masses[5]) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},128,mubarsq); }
            else if (masses[2] == masses[3]) { return LF({masses[0],masses[1],masses[2],masses[4],masses[5]},127,mubarsq); }
            else if (masses[2] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3],masses[5]},127,mubarsq); }
            else if (masses[2] == masses[5]) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},127,mubarsq); }
            else if (masses[3] == masses[4]) { return LF({masses[0],masses[1],masses[2],masses[3],masses[5]},126,mubarsq); }
            else if (masses[3] == masses[5]) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},126,mubarsq); }
            else if (masses[4] == masses[5]) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},125,mubarsq); }
