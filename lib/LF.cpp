...
complex<double> LF(const vector<complex<double> >& masses, int code, double mubarsq) {
    switch(code) {
        case 1: 
        ...
        case 18: 
            ...
            break;
        case 19: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},4,mubarsq); }
            ...
            break;
        case 20: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},5,mubarsq); }
            ...
            break;
        case 21: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},7,mubarsq); }
            ...
            break;
        case 22: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},8,mubarsq); }
            ...
            break;
        case 23: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},10,mubarsq); }
            ...
            break;
        case 24: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},11,mubarsq); }
            ...
            break;
        case 25: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},13,mubarsq); }
            ...
            break;
        case 26: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},14,mubarsq); }
            ...
            break;
        case 27: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},18,mubarsq); }
        ...
        case 29: 
            ...
            break;
        case 30: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},9,mubarsq); }
        ...
        case 32: 
            ...
            break;
        case 33: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},12,mubarsq); }
        ...
        case 35: 
            ...
            break;
        case 36: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},17,mubarsq); }
        ...
        case 43: 
            ...
            break;
        case 44: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},15,mubarsq); }
            ...
            break;
        case 45: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0]},16,mubarsq); }
        ...
        case 58: 
            ...
            break;
        case 59: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},28,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},28,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},21,mubarsq); }
            ...
            break;
        case 60: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},29,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},29,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},22,mubarsq); }
            ...
            break;
        case 61: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},31,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},39,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},23,mubarsq); }
            ...
            break;
        case 62: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},32,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},40,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},24,mubarsq); }
            ...
            break;
        case 63: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},34,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},49,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},25,mubarsq); }
            ...
            break;
        case 64: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},35,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},50,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},26,mubarsq); }
            ...
            break;
        case 65: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},37,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},58,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},27,mubarsq); }
            ...
            break;
        case 66: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},39,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},31,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},23,mubarsq); }
            ...
            break;
        case 67: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},40,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},32,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},24,mubarsq); }
            ...
            break;
        case 68: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},42,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},42,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},25,mubarsq); }
            ...
            break;
        case 69: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},43,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},43,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},26,mubarsq); }
            ...
            break;
        case 70: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},47,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},54,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},27,mubarsq); }
            ...
            break;
        case 71: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},49,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},34,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},25,mubarsq); }
            ...
            break;
        case 72: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},50,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},35,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},26,mubarsq); }
            ...
            break;
        case 73: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},54,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},47,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},27,mubarsq); }
            ...
            break;
        case 74: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},58,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},37,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},27,mubarsq); }
            ...
            break;
        case 75: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},38,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},38,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},30,mubarsq); }
        ...
        case 76: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},31,mubarsq); }
        ...
        case 77: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},32,mubarsq); }
            ...
            break;
        case 78: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},41,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},48,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},33,mubarsq); }
        ...
        case 79: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},34,mubarsq); }
        ...
        case 80: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},35,mubarsq); }
        ...
        case 81: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},37,mubarsq); }
            ...
            break;
        case 82: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},48,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},41,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},33,mubarsq); }
        ...
        case 84: 
            ...
            break;
        case 85: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},53,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},53,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},36,mubarsq); }
        ...
        case 86: 
            ...
            break;
        case 87: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},57,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},46,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},36,mubarsq); }
        ...
        case 89: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},41,mubarsq); }
        ...
        case 90: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},42,mubarsq); }
        ...
        case 91: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},43,mubarsq); }
        ...
        case 92: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},53,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},57,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},46,mubarsq); }
        ...
        case 93: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},47,mubarsq); }
            ...
            break;
        case 94: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},55,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},51,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},44,mubarsq); }
            ...
            break;
        case 95: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},56,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},52,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},45,mubarsq); }
        ...
        case 98: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},55,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},55,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},51,mubarsq); }
        ...
        case 99: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2]},56,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},56,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},52,mubarsq); }
        ...
        case 100: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},53,mubarsq); }
        ...
        case 101: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1]},54,mubarsq); }
            ...
            break;
        case 102: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},76,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},76,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},76,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},66,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},66,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},61,mubarsq); }
            ...
            break;
        case 103: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},77,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},77,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},77,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},67,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},67,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},62,mubarsq); }
            ...
            break;
        case 104: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},79,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},79,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},90,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},68,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},71,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},63,mubarsq); }
            ...
            break;
        case 105: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},80,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},80,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},91,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},69,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},72,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},64,mubarsq); }
            ...
            break;
        case 106: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},81,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},81,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},101,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},70,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},74,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},65,mubarsq); }
            ...
            break;
        case 107: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},83,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},90,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},79,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},71,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},68,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},63,mubarsq); }
            ...
            break;
        case 108: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},84,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},91,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},80,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},72,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},69,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},64,mubarsq); }
            ...
            break;
        case 109: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},86,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},93,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},93,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},73,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},73,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},65,mubarsq); }
            ...
            break;
        case 110: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},88,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},101,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},81,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},74,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},70,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},65,mubarsq); }
            ...
            break;
        case 111: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},90,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},83,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},83,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},71,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},71,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},68,mubarsq); }
            ...
            break;
        case 112: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},91,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},84,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},84,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},72,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},72,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},69,mubarsq); }
            ...
            break;
        case 113: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},93,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},86,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},97,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},73,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},74,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},70,mubarsq); }
            ...
            break;
        case 114: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},97,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},97,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},86,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},74,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},73,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},70,mubarsq); }
            ...
            break;
        case 115: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},101,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},88,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},88,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},74,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},74,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},73,mubarsq); }
            ...
            break;
        case 116: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},89,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},89,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},89,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},82,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},82,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},78,mubarsq); }
        ...
        case 117: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},83,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},83,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},79,mubarsq); }
        ...
        case 118: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},84,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},84,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},80,mubarsq); }
        ...
        case 119: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},86,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},88,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},81,mubarsq); }
        ...
        case 120: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},88,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},86,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},81,mubarsq); }
            ...
            break;
        case 121: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},100,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},96,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},96,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},87,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},87,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},85,mubarsq); }
        ...
        case 122: 
            ...
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},86,mubarsq); }
        ...
        case 123: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3]},100,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},100,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},100,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},96,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},96,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},92,mubarsq); }
        ...
        case 124: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3]},97,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},97,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2]},93,mubarsq); }
            ...
            break;
        case 125: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3],masses[4]},117,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},117,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},117,mubarsq); }
            else if (std::abs(masses[0]/masses[4]) >= 0.95 && std::abs(masses[0]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},117,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},111,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},111,mubarsq); }
            else if (std::abs(masses[1]/masses[4]) >= 0.95 && std::abs(masses[1]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},111,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},107,mubarsq); }
            else if (std::abs(masses[2]/masses[4]) >= 0.95 && std::abs(masses[2]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},107,mubarsq); }
            else if (std::abs(masses[3]/masses[4]) >= 0.95 && std::abs(masses[3]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},104,mubarsq); }
            ...
            break;
        case 126: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3],masses[4]},118,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},118,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},118,mubarsq); }
            else if (std::abs(masses[0]/masses[4]) >= 0.95 && std::abs(masses[0]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},118,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},112,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},112,mubarsq); }
            else if (std::abs(masses[1]/masses[4]) >= 0.95 && std::abs(masses[1]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},112,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},108,mubarsq); }
            else if (std::abs(masses[2]/masses[4]) >= 0.95 && std::abs(masses[2]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},108,mubarsq); }
            else if (std::abs(masses[3]/masses[4]) >= 0.95 && std::abs(masses[3]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},105,mubarsq); }
            ...
            break;
        case 127: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3],masses[4]},119,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},119,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},119,mubarsq); }
            else if (std::abs(masses[0]/masses[4]) >= 0.95 && std::abs(masses[0]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},124,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},113,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},113,mubarsq); }
            else if (std::abs(masses[1]/masses[4]) >= 0.95 && std::abs(masses[1]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},115,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},109,mubarsq); }
            else if (std::abs(masses[2]/masses[4]) >= 0.95 && std::abs(masses[2]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},110,mubarsq); }
            else if (std::abs(masses[3]/masses[4]) >= 0.95 && std::abs(masses[3]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},106,mubarsq); }
            ...
            break;
        case 128: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3],masses[4]},120,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},120,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},124,mubarsq); }
            else if (std::abs(masses[0]/masses[4]) >= 0.95 && std::abs(masses[0]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},119,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},114,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},115,mubarsq); }
            else if (std::abs(masses[1]/masses[4]) >= 0.95 && std::abs(masses[1]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},113,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},110,mubarsq); }
            else if (std::abs(masses[2]/masses[4]) >= 0.95 && std::abs(masses[2]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},109,mubarsq); }
            else if (std::abs(masses[3]/masses[4]) >= 0.95 && std::abs(masses[3]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},106,mubarsq); }
            ...
            break;
        case 129: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3],masses[4]},122,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},124,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},120,mubarsq); }
            else if (std::abs(masses[0]/masses[4]) >= 0.95 && std::abs(masses[0]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},120,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},115,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},114,mubarsq); }
            else if (std::abs(masses[1]/masses[4]) >= 0.95 && std::abs(masses[1]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},114,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},110,mubarsq); }
            else if (std::abs(masses[2]/masses[4]) >= 0.95 && std::abs(masses[2]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},110,mubarsq); }
            else if (std::abs(masses[3]/masses[4]) >= 0.95 && std::abs(masses[3]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},109,mubarsq); }
            ...
            break;
        case 130: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3],masses[4]},124,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},122,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},122,mubarsq); }
            else if (std::abs(masses[0]/masses[4]) >= 0.95 && std::abs(masses[0]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},122,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},115,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},115,mubarsq); }
            else if (std::abs(masses[1]/masses[4]) >= 0.95 && std::abs(masses[1]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},115,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},114,mubarsq); }
            else if (std::abs(masses[2]/masses[4]) >= 0.95 && std::abs(masses[2]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},114,mubarsq); }
            else if (std::abs(masses[3]/masses[4]) >= 0.95 && std::abs(masses[3]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},113,mubarsq); }
        ...
        case 131: 
            ...
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4]},122,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},122,mubarsq); }
            else if (std::abs(masses[1]/masses[4]) >= 0.95 && std::abs(masses[1]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},122,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4]},120,mubarsq); }
            else if (std::abs(masses[2]/masses[4]) >= 0.95 && std::abs(masses[2]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},120,mubarsq); }
            else if (std::abs(masses[3]/masses[4]) >= 0.95 && std::abs(masses[3]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3]},119,mubarsq); }
            ...
            break;
        case 132: 
            if (std::abs(masses[0]/masses[1]) >= 0.95 && std::abs(masses[0]/masses[1]) <= 1.05){ return LF({masses[0],masses[2],masses[3],masses[4],masses[5]},131,mubarsq); }
            else if (std::abs(masses[0]/masses[2]) >= 0.95 && std::abs(masses[0]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4],masses[5]},131,mubarsq); }
            else if (std::abs(masses[0]/masses[3]) >= 0.95 && std::abs(masses[0]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4],masses[5]},131,mubarsq); }
            else if (std::abs(masses[0]/masses[4]) >= 0.95 && std::abs(masses[0]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3],masses[5]},131,mubarsq); }
            else if (std::abs(masses[0]/masses[5]) >= 0.95 && std::abs(masses[0]/masses[5]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},131,mubarsq); }
            else if (std::abs(masses[1]/masses[2]) >= 0.95 && std::abs(masses[1]/masses[2]) <= 1.05) { return LF({masses[0],masses[1],masses[3],masses[4],masses[5]},130,mubarsq); }
            else if (std::abs(masses[1]/masses[3]) >= 0.95 && std::abs(masses[1]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4],masses[5]},130,mubarsq); }
            else if (std::abs(masses[1]/masses[4]) >= 0.95 && std::abs(masses[1]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3],masses[5]},130,mubarsq); }
            else if (std::abs(masses[1]/masses[5]) >= 0.95 && std::abs(masses[1]/masses[5]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},130,mubarsq); }
            else if (std::abs(masses[2]/masses[3]) >= 0.95 && std::abs(masses[2]/masses[3]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[4],masses[5]},129,mubarsq); }
            else if (std::abs(masses[2]/masses[4]) >= 0.95 && std::abs(masses[2]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3],masses[5]},129,mubarsq); }
            else if (std::abs(masses[2]/masses[5]) >= 0.95 && std::abs(masses[2]/masses[5]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},129,mubarsq); }
            else if (std::abs(masses[3]/masses[4]) >= 0.95 && std::abs(masses[3]/masses[4]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3],masses[5]},128,mubarsq); }
            else if (std::abs(masses[3]/masses[5]) >= 0.95 && std::abs(masses[3]/masses[5]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},128,mubarsq); }
            else if (std::abs(masses[4]/masses[5]) >= 0.95 && std::abs(masses[4]/masses[5]) <= 1.05) { return LF({masses[0],masses[1],masses[2],masses[3],masses[4]},127,mubarsq); }
